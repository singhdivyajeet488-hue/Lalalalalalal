    ...
    switch (commandName) {
      ...
      case 'play': {
        ...
        try {
          ...
          // Delete the deferred reply; playSong/addSong events send the real embed
          await interaction.deleteReply().catch(() => {});
        } catch (playErr) {
          console.error('[play] inner error:', playErr.message);
          await interaction.editReply(`❌ ${playErr.message}`).catch(() => {});
        }
        break;
      }
